...
namespace PaintTower.Canvas {
    ...
    /// </summary>
    public class GuestResolvingWarning : HUD {
        ...
        public void OnClickConfirmButton() {
            UnloadHUD();
            (GameLogic.Instance.GuestBeforeMatchTooltip as GuestBeforeMatchTooltip).Text = "Aponte a câmera para o mesmo local do Host.";
            GameLogic.Instance.SetGameState(Enum.GameState.GUEST_PREPARATION);
        }
